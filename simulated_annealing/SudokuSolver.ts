 ...
 * @original-author dsbalico — https://github.com/dsbalico/sudoku-solver-using-simulated-annealing/blob/main/src/algorithm/SudokuSolver.ts
 * @description Solves Sudoku puzzles via simulated annealing with reheating.
 */
